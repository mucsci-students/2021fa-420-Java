...
public class Controller implements ActionListener, MouseListener, MouseMotionListener {
	...
	public void actionPerformed(ActionEvent e) {
						...
						if (input.hasNext()) {
							...
							if (input.hasNext()) {
								...
								if (!dupes.contains(methodNameMO)) {
									Parameters.addParameter(classNameMO, methodNameMO, paramNameMO, typeMO, null,
											false);
									View.inputPanel.setVisible(false);
									View.textField.setText("");
								} else {
									...
									View.inputLbl.setText(
											"<html><div style='text-align:center'>There is more than<br>one method that<br>uses the name "
													+ methodNameMO
													+ "<br>Enter all the parameter<br>types for the method<br>you are editing<div></html>");
						...
						if (input.hasNext()) {
							...
							if (input.hasNext()) {
								...
								if (input.hasNext()) {
									...
									HashSet<String> dupes = MethodOverloading.containsDuplicateMethods(classNameMO);
									if (!dupes.contains(methodNameMO)) {
										Parameters.changeParameter(classNameMO, methodNameMO, oldParamNameMO,
				...
				if (input.hasNext()) {
					...
					if (input.hasNext()) {
						...
						if (pList != null) {
							...
							if (!pList.isEmpty()) {
								View.inputLbl.setText(
										"<html><div style='text-align:center'>Here is the parameter<br>being changed:<br>"
												+ pList.get(0).getParamType() + " " + pList.get(0).getParamName()
												+ "<br><br>What is the new name?<br><br>What is the new type?</div></html>");
							}
							// There were no parameters to change
							else {
								JOptionPane.showMessageDialog(View.frmUmlEditor, "There are no parameters to change!",
					...
					if (input.hasNext()) {
						...
						if (!dupes.contains(paramName)) {
							...
							if (counter < pList.size()) {
								View.inputLbl.setText(
										"<html><div style='text-align:center'>Here is the parameter<br>being changed:<br>"
												+ pList.get(counter).getParamType() + " "
												+ pList.get(counter).getParamName()
												+ "<br><br>What is the new name?<br><br>What is the new type?</div></html>");
								View.textField.setText("");
							}
			...
			// If user wanted to add more fields
				...
				if (input.hasNext()) {
					...
					if (!answer.equals("yes") && !answer.equals("no")) {
						...
						View.inputLbl.setText(
								"<html><div style='text-align:center'>Please respond with<br>yes or no!</div></html>");
					} else if (answer.equals("yes")) {
						// Asks for add field information
						View.inputLbl.setText(
								"<html><div style='text-align:center'>What class are<br>you adding to?<br><br>What would you like to<br>name the new field?<br><br>What type do you want<br>the new field to have?<br><div></html>");
						command = "Add Field";
						View.textField.setText("");
			...
			// If user wanted to remove more fields
				...
				if (input.hasNext()) {
					...
					if (!answer.equals("yes") && !answer.equals("no")) {
						...
						View.inputLbl.setText(
								"<html><div style='text-align:center'>What class are<br>you removing from?<br><br>What field are<br>you removing?<div></html>");
							...
							if (Model.getNoClassDupes().contains(sourceName)) {
								...
								// Destination class does not exist
									...
									JOptionPane.showMessageDialog(View.frmUmlEditor,
											"Destination class does not exist!", "Error", JOptionPane.ERROR_MESSAGE);
								}
							}
							// Source class does not exist
							else {
								JOptionPane.showMessageDialog(View.frmUmlEditor, "Source class does not exist!",
										"Error", JOptionPane.ERROR_MESSAGE);
							}
						} else {
							JOptionPane.showMessageDialog(View.frmUmlEditor, "Invalid input", "Error",
		...
		// If add class button is clicked
			...
			command = "Add Class";
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What would you like<br>to name the new class?</div></html>");
		...
		// If remove class button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would<br>you like to remove?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If rename class button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to rename?<br><br>What is the new<br>class name?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If add method button is clicked
			...
			command = "Add Method";
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are you<br>adding to?<br><br>What is the name of<br>the new method?<br><br>What is the method's<br>return type?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If remove method button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are you<br>removing from?<br><br>What method are you<br>removing?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If remove all methods button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are you<br>removing all methods<br>from?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If rename method button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are you<br>making modifications in?<br><br>What method are<br>you renaming?<br><br>What would you like to<br>rename the method to?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If add parameter button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to add a parameter to?<br><br>What method would you<br>like to add a parameter to?<br><br>What is the<br>parameter name?<br><br>What is the<br>parameter type?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If remove parameter button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to remove the<br>parameter from?<br><br>What method would you<br>like to remove the<br>parameter from?<br><br>What is the<br>parameter name?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If remove all parameters button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to remove the<br>parameters from?<br><br>What method would you<br>like to remove the<br>parameters from?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If change parameter button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to change<br>a parameter in?<br><br>What method would you<br>like to change<br>a parameter in?<br><br>What is the old<br>parameter name?<br><br>What is the new<br>parameter name?<br><br>What is the<br>parameter type?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If change all parameters button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to rename<br>parameters in?<br><br>What method would you<br>like to rename<br>parameters in?</div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If add field button is clicked
			...
			command = "Add Field";
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are<br>you adding to?<br><br>What would you like to<br>name the new field?<br><br>What type do you want<br>the new field to have?<div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If rename field button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class are you<br>making modifications in?<br><br>What field are<br>you renaming?<br><br>What would you like to<br>rename the field to?<div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If add relationship button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you<br>like to be the source<br>of the relation?<br><br>What is the destination<br>of the relation?<br><br>What is the type of the<br>relation? Type must be<br>aggregation, composition,<br>inheritance, or realization.<div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If remove relationship button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What class would you like<br>to delete a relation from?<br><br>What is the destination<br>of the relation?<div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If change relationship button is clicked
			...
			View.inputLbl.setText(
					"<html><div style='text-align:center'>What is the source<br>class of the relationship<br>you would like to change?<br><br>What is the destination<br>class of the relationship<br>you would like to change?<br><br>What would you like<br>to change the type to?<div></html>");
			View.inputPanel.setVisible(true);
		}
		...
		// If help button is clicked
			...
			JOptionPane.showMessageDialog(View.frmUmlEditor,
					"<html>For commands with multiple inputs, put them in order separated with a space"
							+ "<br>add class - creates a new class" + "<br>delete class - deletes a class"
							+ "<br>rename class - renames a class" + "<br>add method - creates a new method for a class"
							...
							+ "<br>undo - undos a change made" + "<br>redo - redos an undo made"
							+ "<br>save - saves current uml file" + "<br>load - loads a uml file"
