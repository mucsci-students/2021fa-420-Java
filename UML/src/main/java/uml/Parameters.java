...
public class Parameters {
	...
	public static boolean deleteParameter(String UMLName, String methodsName, String pName, ArrayList<Parameters> pList,
		...
		if (index != -1) {
			...
			if (Driver.guiUp) {
				JOptionPane.showMessageDialog(View.frmUmlEditor, "That parameter does not exist!", "Error",
						JOptionPane.ERROR_MESSAGE);
			} else {
	...
	public static boolean deleteAllParameters(String UMLName, String methodsName, ArrayList<Parameters> pList,
		...
		if (pList.isEmpty()) {
			if (Driver.guiUp) {
				JOptionPane.showMessageDialog(View.frmUmlEditor, "There are no parameters to remove.", "Error",
						JOptionPane.ERROR_MESSAGE);
			} else {
